...
CREATE TABLE IF NOT EXISTS `simm`.`costos_maquinas` (
  ...
  `name` VARCHAR(50) NOT NULL,
  `val_adq` DECIMAL(10,5) NULL,
  `val_neum` DECIMAL(10,5) NULL,
  `vida_util` DECIMAL(10,5) NULL,
  `vida_util_neum` DECIMAL(10,5) NULL,
  `horas_total_uso` DECIMAL(10,5) NULL,
  `horas_efec_uso` DECIMAL(10,5) NULL,
  `horas_mens_uso` DECIMAL(10,5) NULL,
  `horas_dia_uso` DECIMAL(10,5) NULL,
  `tasa_int_simple` DECIMAL(10,5) NULL,
  `factor_cor` DECIMAL(10,5) NULL,
  `coef_err_mec` DECIMAL(10,5) NULL,
  `consumo` DECIMAL(10,5) NULL,
  `lubricante` DECIMAL(10,5) NULL,
  `costo_alquiler` DECIMAL(10,5) NULL,
  `maquinas_idmaquinas` INT NOT NULL,
  `created` DATE NOT NULL,
  `finished` DATE NULL,
  `active` TINYINT(1) NULL,
  `users_idusers` INT NOT NULL,
  PRIMARY KEY (`idcostos_maquinas`),
...
CREATE TABLE IF NOT EXISTS `simm`.`arreglos_mecanicos` (
  ...
  `modified` DATE NULL DEFAULT ON UPDATE CURRENT_TIMESTAMP,
