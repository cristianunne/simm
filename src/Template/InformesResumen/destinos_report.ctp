                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div style="display: flex; align-items: baseline; column-gap: 5px; margin-top: 10px;">
                                    ...
                                    <?= $this->Form->control('destino', ['options' => $destinos,
                            ...
                            <div class="col-md-9">
                                <div style="display: flex; align-items: baseline; column-gap: 5px; margin-top: 20px;">
                                    <?=  $this->Form->label('Productos: ') ?>
                                    <?= $this->Form->control('productos', ['options' => $productos,
                                        'empty' => '(Elija una Opcion)', 'type' => 'select',
                                        'class' => 'form-control', 'placeholder' => 'Parcela',
                                        'label' => false, 'required']) ?>
                                </div>
