                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <?= $this->Form->text('remito_number', [
                                        'class' => 'form-control', 'placeholder' => '', 'disabled',
                                        'style' => ['text-align: right;'], 'id' => 'remito_number']) ?>
                                </div>
                            ...
                            <div class="col-md-3" style="border-right: solid 1px #c1c1c1;">
                                ...
                                <div class="form-group" id="sandbox-container">
                                    ...
                                    <div class="input-append date">
                                        <input id="fecha" name="fecha" type="date" class="span2" required value="<?= h($remito->fecha->format('Y-m-d')) ?>">
                                    </div>
                                ...
                                <div class="form-group">
                                    <?= $this->Form->control('parcelas_idparcelas', ['options' => $parcela,
                                        'empty' => '(Elija una Parcela)', 'type' => 'select', 'attr' => 'edit',
                                ...
                                <div style="display: flex;">
                                    ...
                                    <?= $this->Form->control('propietarios_idpropietarios', ['options' => $propietario,
                                ...
                                <div style="display: flex;">
                                    ...
                                    <?= $this->Form->control('destinos_iddestinos', ['options' => $destino,
                            ...
                            <?php foreach ($lotes as $lote): ?>
                                ...
                                <tr>
                                    ...
                                    <td class="actions" style="text-align: center">
                                        <?= $this->Form->button($this->Html->tag('span', '', ['class' => 'fas fa-check', 'aria-hidden' => 'true']),
                                            ['type' => 'button', 'class' => 'btn btn-success', 'escape' => false,
                                                'attr' => $lote->name, 'attr2' =>  $lote->idlotes,  'id' => 'remitos_edit',
