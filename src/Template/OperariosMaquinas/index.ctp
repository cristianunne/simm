                        ...
                        <tr>
                            ...
                            <td class="actions" style="text-align: center">
                                ...
                                <?= $this->Form->postLink(__($this->Html->tag('span', '', ['class' => 'fas fa-trash-alt', 'aria-hidden' => 'true'])),
                                        ...
                                        ['confirm' => __('Eliminar?'), 'class' => 'btn btn-danger','escape' => false]) ?>

                            </td>

                            <td class="actions" style="text-align: center">
                                <?= $this->Html->link($this->Html->tag('span', '', ['class' => 'fas fa-eye', 'aria-hidden' => 'true']),
                                    ['action' => 'viewHistory', $oper->operarios_idoperarios,
                                        $oper->maquinas_idmaquinas], ['class' => 'btn bg-lightblue', 'escape' => false]) ?>
                            </td>
