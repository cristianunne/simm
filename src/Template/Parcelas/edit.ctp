                ...
                <div class="row">
                    <div class="col-md-6 card box-simm-shadow" style="margin: 0 auto; padding: 1.25rem">
                        ...
                        <div style="display: flex;">
                            ...
                            <?php if($parcelas->propietario->tipo == 'Persona'):  ?>
                                <?= $this->Form->text('propietario_name', ['class' => 'form-control', 'placeholder' => 'Propietario',
                                    'disabled', 'id' => 'input_prop', 'style'=> 'margin-right: 10px;',
                                    'value' => $parcelas->propietario->firstname.' ' . $parcelas->propietario->lastname]) ?>
                            <?php else: ?>
                                <?= $this->Form->text('propietario_name', ['class' => 'form-control', 'placeholder' => 'Propietario',
                                    'disabled', 'id' => 'input_prop', 'style'=> 'margin-right: 10px;', 'value' => $parcelas->propietario->name]) ?>
                            <?php endif;?>
                        ...
                        <div style="display: flex;">
                            <?= $this->Form->text('lotes_name', ['class' => 'form-control', 'placeholder' => 'Lotes',
                                'disabled', 'id' => 'input_lotes', 'style'=> 'margin-right: 10px;', 'value' => $parcelas->lote->name]) ?>
