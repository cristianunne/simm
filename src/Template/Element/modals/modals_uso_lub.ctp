<!-- Modal -->
<div class="modal fade" id="modal_uso_lub" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl " role="document">
        <div class="modal-content">
            <div class="modal-header bg-navy">
                <h4 class="modal-title" id="tittle_modal_propietarios">Lubricantes</h4>
                <button type="button" class="close" style="margin-top:-25px" data-dismiss="modal" aria-label="Close" attr="modal_uso_lub"
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    <button id="button_upload" type="button" class="btn-navy btn bg-navy" attr="modal_uso_lub" onclick="closeModal(this)">Salir</button>
                </div>
            </div>
        </div>
    </div>
