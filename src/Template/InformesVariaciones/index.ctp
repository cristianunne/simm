        ...
        <div class="card color-palette-box">
            ...
            <div class="card-body table-responsive">
                ...
                <table id="tabladata" class="table table-bordered table-hover dataTable">
                    ...
                    <tbody>
                    <?php foreach ($informes_var_grupo as $inf): ?>

                        <tr>
                            <td class="dt-center"><?= h($inf->idinformes_variaciones) ?></td>
                            ...
                            <?php if(!empty($inf->path)):  ?>
                                ...
                                <td class="dt-center">
                                    <?= $this->Html->link($this->Html->tag('span', '', ['class' => 'glyphicon far fa-file-excel', 'aria-hidden' => 'true']),
                                        ['controller' => 'InformesVariaciones', 'action' => 'downloadAsExcel', $inf->idinformes_variaciones],
                            ...
                            <td class="actions" style="text-align: center;">
                                ...
                                <?php if($current_user['role'] == 'supervisor' or $current_user['role'] == 'admin'):  ?>
                                    <?= $this->Form->postLink(__($this->Html->tag('span', '', ['class' => 'fas fa-trash-alt', 'aria-hidden' => 'true'])),
                                        ['action' => 'delete', $inf->idinformes_variaciones],
                                        ['confirm' => __('Eliminar {0}?', $inf->idinformes_variaciones), 'class' => 'btn btn-danger','escape' => false]) ?>
        ...
        <div class="card color-palette-box">
            ...
            <div class="card-body table-responsive">
                ...
                <table id="tabladata_2" class="table table-bordered table-hover dataTable">
                    ...
                    <tbody>
                    <?php foreach ($informes_var_maquina as $inf): ?>

                        <tr>
                            <td class="dt-center"><?= h($inf->idinformes_variaciones) ?></td>
                            <td class="dt-center"><?= h($inf->created) ?></td>
                            <td class="dt-center"><?= h($inf->maquina) ?></td>
                            <td class="dt-center"><?= h($inf->fecha_inicio) ?></td>
                            <td class="dt-center"><?= h($inf->fecha_fin) ?></td>
                            <td class="dt-center"><?= h($inf->lote) ?></td>
                            <td class="dt-center"><?= h($inf->parcela) ?></td>
