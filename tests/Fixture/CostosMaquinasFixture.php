...
class CostosMaquinasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'metod_costos_idmetod_costos' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            ...
            'fk_costos_maquinas_metod_costos1_idx' => ['type' => 'index', 'columns' => ['metod_costos_idmetod_costos'], 'length' => []],
        ],
        '_constraints' => [
            ...
            'fk_costos_maquinas_metod_costos1' => ['type' => 'foreign', 'columns' => ['metod_costos_idmetod_costos'], 'references' => ['metod_costos', 'idmetod_costos'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
