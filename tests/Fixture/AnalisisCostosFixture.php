...
/**
 * AnalisisCostosFixture
 */
class AnalisisCostosFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        'idanalisis_costos' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'autoIncrement' => true, 'precision' => null],
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['idanalisis_costos'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
